...
from ..generators import sq_root
from .task_template import TaskPageTemplate


class Sq_RootPage(Frame):
	task = {"eng": "Square root", "rus": "Квадратный корень"}
	...
	def __init__(self, parent, lang, version, prev, bg, fg, afg, dfg, b_bg, b_bg1, b_abg, e_bg, e_hl):
		...
		def new_task(full_reset: bool = True):
			if full_reset:
				task_data = sq_root(version, self.winfo_width(), self.winfo_height(),
